...
class ProductPagesPresenter extends BasePresenter
{
    // OTHER
    ...
    public function actionBreedbook()
    {
        ...
        //$this->template->templateCustomName = "tools-detail";
    }

    public function actionLed()
    {
        $this->customPageName = "LED Strip Controller";

        $this->template->pageType = "product_page";
        //$this->template->templateCustomName = "tools-detail";
    }

    public function actionSpedisimo()
    {
        $this->customPageName = "Spedisimo";

        $this->template->pageType = "product_page";
        //$this->template->templateCustomName = "tools-detail";
    }

    public function actionScavent()
    {
        $this->customPageName = "Scavent";
